...
public class BasicCustomAuthenticator extends AbstractApplicationAuthenticator implements LocalApplicationAuthenticator {
    ...
    protected void processAuthenticationResponse(HttpServletRequest request,
        ...
        String username = request.getParameter(org.wso2.custom.authenticator.local.BasicCustomAuthenticatorConstants.USER_NAME);
    ...
    public String getFriendlyName() {
        ...
        return org.wso2.custom.authenticator.local.BasicCustomAuthenticatorConstants.AUTHENTICATOR_FRIENDLY_NAME;
    }

    @Override
    public boolean canHandle(HttpServletRequest httpServletRequest) {
        String userName = httpServletRequest.getParameter(org.wso2.custom.authenticator.local.BasicCustomAuthenticatorConstants.USER_NAME);
        String password = httpServletRequest.getParameter(org.wso2.custom.authenticator.local.BasicCustomAuthenticatorConstants.PASSWORD);
    ...
    public String getName() {
        return org.wso2.custom.authenticator.local.BasicCustomAuthenticatorConstants.AUTHENTICATOR_NAME;
    }
}
